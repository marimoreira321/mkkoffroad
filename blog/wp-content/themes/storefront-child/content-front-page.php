	...
	<div class="row mt-0 pt-0 reveal l-fade-scroll" id="products">
		...
		<div class="container w-100 bg-white py-5">
			<div class="row justify-content-center">
				<div class="col-12 col-sm-3">
					<product title="BAGS UNIVERSAIS" :thumb="'<?= $t_uri.'/assets/images/diminas/cat_01.webp' ?>'" :uri="'/'">
					</product>
				</div>
				<div class="col-12 col-sm-3">
					<product title="ILUMINAÇÃO" :thumb="'<?= $t_uri.'/assets/images/diminas/cat_02.webp' ?>'" :uri="'/'">
					</product>
				</div>
				<div class="col-12 col-sm-3">
					<product title="ACESSÓRIOS" :thumb="'<?= $t_uri.'/assets/images/diminas/cat_03.webp' ?>'" :uri="'/'">
					</product>
				</div>
				<div class="col-12 col-sm-3">
		...
		<div class="container w-100 bg-white py-5">
			<div class="row justify-content-center">
				...
				<div class="col-12 col-sm-3">
					<product title="TECNOLOGIA" :thumb="'<?= $t_uri.'/assets/images/diminas/it_04.webp' ?>'"
						:uri="'/'">
					</product>
				</div>
			</div>
