...
<div class="col-12 ">
    ...
    <div class="row mb-3">
        ...
        <img class="d-md-none" src="<?php echo get_template_directory_uri().'/assets/images/diminas/default.png'?>" style="height: 100px">
            <ul id="menu_right" class="d-none m-0 d-md-flex pt-5 py-sm-0 px-0 px-sm-3 align-items-center text-strong w-100 justify-content-center">
                <li class="menu-item ml-md-5 p-3"><a href="/">HOME</a></li>
                <li class="menu-item p-3"><a href="/blog/loja">PRODUTOS</a></li>
                <li class="menu-item p-3"><a href="/">SOBRE NÓS</a></li>
                <li class="menu-item p-3"><a href="/">FAQ</a></li>
